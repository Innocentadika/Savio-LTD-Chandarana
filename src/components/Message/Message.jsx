...
const Message = () => {
  return (
    <div style={{ backgroundImage: `url(${Backpicture})`, backgroundSize: 'cover'}} className='p-8 sm:p-10 lg:p-24 text-left lg:text-xl sm:text-lg text-gray-300'>
      <div className='px-4 lg:px-24   py-2 text-lg text-green-500 font-bold sm:text-xl lg:text-3xl'>
