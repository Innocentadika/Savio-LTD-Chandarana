...
const Accounts = () => {
  return (
    ...
    <div className='justify-between md:flex sm:flex lg:flex space-x-2 space-y-3'>
      <div style={{height: 150}} className=' sm:px-6  p-4 sm:text-base lg:px-44 lg:text-xl space-y-1 bg-lime-500'>
        <h1 className='text-white font-light'>SUBSCRIBE FOR OUR <span className='font-extrabold'>NEWSLETTER</span></h1>
